...
public class TextViewShow_ extends TextView{
	 private int m_rotate;  
     public TextViewShow_ (Context context) {
             super(context);                        
     }
     
     public TextViewShow_(Context context, AttributeSet attrs) {
             super(context, attrs);
//             TypedArray array = context.obtainStyledAttributes(attrs,R.styleable.LabelView);
//             this.m_rotate = array.getInt(0, 90);
     }
     
     public TextViewShow_(Context context, AttributeSet attrs,int defStyle) {
     ...
     protected void onDraw(Canvas canvas){
             ...
             canvas.rotate(22, getWidth(), getHeight());
             super.onDraw(canvas);
     }
